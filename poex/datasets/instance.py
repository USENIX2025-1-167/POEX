...
class Instance:
    def __init__(self, *, query:str=None, jailbreak_prompt:str=None, reference_responses:'List[str]'=None, target_responses:'List[str]'=None, constraint_score:float=None, all_loss:float=None, eval_results:list=None, eval_policy_score:list=None, parents:list=None, children:list=None, attack_attrs=None, **kwargs):
        """
        ...
        if eval_policy_score is None:
            eval_policy_score = []
        self.eval_policy_score = eval_policy_score
