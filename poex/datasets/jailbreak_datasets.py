        ...
        with jsonlines.open(path, mode='w') as writer:
            for instance in self._dataset:
                data = {
                    ...
                    'eval_policy_score': getattr(instance, 'eval_policy_score', None),
                    'epoch': getattr(instance, 'epoch', None),
                    'all_loss': getattr(instance, 'all_loss', None),
                    'constraint_score': getattr(instance, 'constraint_score', None),
                }
                writer.write(data)
